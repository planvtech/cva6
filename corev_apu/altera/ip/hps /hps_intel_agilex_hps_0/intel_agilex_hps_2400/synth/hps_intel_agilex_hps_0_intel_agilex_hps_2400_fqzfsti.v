// hps_intel_agilex_hps_0_intel_agilex_hps_2400_fqzfsti.v
...
`timescale 1 ps / 1 ps
module hps_intel_agilex_hps_0_intel_agilex_hps_2400_fqzfsti (
		...
		inout  wire        SDMMC_CMD,     //         hps_io.SDMMC_CMD
	...
	hps_intel_agilex_hps_0_intel_agilex_interface_generator_191_k4pw6ba #(
		.F2S_DATA_WIDTH      (0),
		...
		.h2f_WDATA     (h2f_WDATA),     //  output,  width = 64,               .wdata
		.h2f_WSTRB     (h2f_WSTRB),     //  output,   width = 8,               .wstrb
		...
		.h2f_RDATA     (h2f_RDATA),     //   input,  width = 64,               .rdata
		...
		.SDMMC_CMD     (SDMMC_CMD),     //   inout,   width = 1,         hps_io.SDMMC_CMD
