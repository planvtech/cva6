...
module emif_cal (
	...
	emif_cal_altera_emif_cal_274_qortvxi emif_cal_0 (
		...
		.cal_debug_clk_clk       (cal_debug_clk_clk),       //   input,     width = 1,     cal_debug_clk.clk
		.cal_debug_reset_n_reset (cal_debug_reset_n_reset)  //   input,     width = 1, cal_debug_reset_n.reset
	);
