// cva6_intel_altera_mm_interconnect_1920_7uifsqq.v
...
`timescale 1 ps / 1 ps
module cva6_intel_altera_mm_interconnect_1920_7uifsqq (
		...
		input  wire         axi_bridge_0_clk_reset_reset_bridge_in_reset_reset,                        //                        axi_bridge_0_clk_reset_reset_bridge_in_reset.reset,        Reset Input
	...
	wire  [220:0] cmd_demux_src0_data;                                      // cmd_demux:src0_data -> crosser:in_data
	...
	wire  [220:0] crosser_out_data;                                         // crosser:out_data -> cmd_mux:sink0_data
	...
	wire  [220:0] cmd_demux_001_src0_data;                                  // cmd_demux_001:src0_data -> crosser_001:in_data
	...
	wire  [220:0] crosser_001_out_data;                                     // crosser_001:out_data -> cmd_mux:sink1_data
	...
	wire  [220:0] rsp_demux_src0_data;                                      // rsp_demux:src0_data -> crosser_002:in_data
	...
	wire  [220:0] crosser_002_out_data;                                     // crosser_002:out_data -> rsp_mux:sink0_data
	...
	wire  [220:0] rsp_demux_src1_data;                                      // rsp_demux:src1_data -> crosser_003:in_data
	...
	wire  [220:0] crosser_003_out_data;                                     // crosser_003:out_data -> rsp_mux_001:sink0_data
	...
	cva6_intel_altera_merlin_multiplexer_1922_iqaypey cmd_mux (
		...
		.sink0_data          (crosser_out_data),                                                  //   input,  width = 221,          .data
		...
		.sink1_data          (crosser_001_out_data),                                              //   input,  width = 221,          .data
	...
	cva6_intel_altera_merlin_multiplexer_1922_bnupvua rsp_mux (
		...
		.sink0_data          (crosser_002_out_data),                                             //   input,  width = 221,          .data
	...
	cva6_intel_altera_merlin_multiplexer_1922_bnupvua rsp_mux_001 (
		...
		.sink0_data          (crosser_003_out_data),                                             //   input,  width = 221,          .data
	...
	cva6_intel_hs_clk_xer_1940_q6vwcpq #(
		.DATA_WIDTH          (221),
		.BITS_PER_SYMBOL     (221),
		.USE_PACKETS         (1),
		.USE_CHANNEL         (1),
		...
		.in_reset          (axi_bridge_0_clk_reset_reset_bridge_in_reset_reset),                        //   input,    width = 1,  in_clk_reset.reset
		...
		.in_data           (cmd_demux_src0_data),                                                       //   input,  width = 221,              .data
		...
		.out_data          (crosser_out_data),                                                          //  output,  width = 221,              .data
		.in_empty          (1'b0),                                                                      // (terminated),                             
		.in_error          (1'b0),                                                                      // (terminated),                             
		.out_empty         (),                                                                          // (terminated),                             
		.out_error         ()                                                                           // (terminated),                             
	...
	cva6_intel_hs_clk_xer_1940_q6vwcpq #(
		...
		.in_data           (cmd_demux_001_src0_data),                                                   //   input,  width = 221,              .data
		...
		.out_data          (crosser_001_out_data),                                                      //  output,  width = 221,              .data
		.in_empty          (1'b0),                                                                      // (terminated),                             
		.in_error          (1'b0),                                                                      // (terminated),                             
		.out_empty         (),                                                                          // (terminated),                             
		.out_error         ()                                                                           // (terminated),                             
	...
	cva6_intel_hs_clk_xer_1940_q6vwcpq #(
		...
		.out_reset         (axi_bridge_0_clk_reset_reset_bridge_in_reset_reset),                        //   input,    width = 1, out_clk_reset.reset
		...
		.in_data           (rsp_demux_src0_data),                                                       //   input,  width = 221,              .data
		...
		.out_data          (crosser_002_out_data),                                                      //  output,  width = 221,              .data
		.in_empty          (1'b0),                                                                      // (terminated),                             
		.in_error          (1'b0),                                                                      // (terminated),                             
		.out_empty         (),                                                                          // (terminated),                             
		.out_error         ()                                                                           // (terminated),                             
	...
	cva6_intel_hs_clk_xer_1940_q6vwcpq #(
		...
		.in_data           (rsp_demux_src1_data),                                                       //   input,  width = 221,              .data
		...
		.out_data          (crosser_003_out_data),                                                      //  output,  width = 221,              .data
		.in_empty          (1'b0),                                                                      // (terminated),                             
		.in_error          (1'b0),                                                                      // (terminated),                             
		.out_empty         (),                                                                          // (terminated),                             
		.out_error         ()                                                                           // (terminated),                             
